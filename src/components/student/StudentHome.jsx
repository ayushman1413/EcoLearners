  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-8">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-4">Keep it up! 🔥</p>
          </div>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="eco-card p-6"
      >
        <h2 className="text-xl font-semibold text-foreground mb-4">Featured Content</h2>
          ...
          {featuredContent.map((content, index) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <h3 className="text-sm font-semibold text-foreground mb-1">{content.title}</h3>
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full eco-button py-2 text-sm"
            >
              Subscribe
            </motion.button>
          </form>
        ...
        <div className="space-y-2">
          ...
          <div className="w-full bg-muted rounded-full h-3">
            <motion.div
              ...
              className="bg-gradient-to-r from-primary to-eco-sun h-3 rounded-full"
            ></motion.div>
          </div>
        ...
        <div className="grid grid-cols-7 gap-1 md:gap-2">
          {dailyRewards.map((reward, index) => (
            ...
            >
              ...
              <div className={`text-lg mb-1 ${reward.claimed ? 'text-primary' : 'text-muted-foreground'}`}>
                {reward.claimed ? '✓' : '🎁'}
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center">
                  <span className="text-primary font-semibold text-sm">{user.avatar}</span>
                </div>
                <span className={`font-medium ${user.isCurrent ? 'text-primary' : 'text-foreground'}`}>
                  {user.name}
                </span>
              </div>
      ...
      >
        <h2 className="text-xl font-semibold text-foreground mb-2">Spin & Win!</h2>
      ...
      >
        ...
        <div className="space-y-4">
          {socialFeed.map((post, index) => (
            ...
            >
              <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                <span className="text-primary font-semibold text-sm">{post.avatar}</span>
              </div>
              <div className="flex-1">
                <p className="text-sm">
        ...
        <div className="relative">
          ...
          <div className="w-full bg-muted rounded-full h-2 mb-4">
            <motion.div
              ...
              className="bg-gradient-to-r from-primary to-eco-sun h-2 rounded-full"
            ></motion.div>
          </div>
